...
static GOLD: &[(u128, &str)] = &[
    (
        0x008fca0000000404000000130c047225u128,
        "IMAD.WIDE.U32.X R4, P0, R12, R19, R4, P0",
    ),
    (
        0x010fca00000004080000000f0c1a7225u128,
        "IMAD.WIDE.U32.X R26, P0, R12, R15, R8, P0",
    ),
    (
        0x020fc800000004080000000d0c087225u128,
        "IMAD.WIDE.U32.X R8, P0, R12, R13, R8, P0",
    ),
    (
        0x000fe200000004040000001706047225u128,
        "IMAD.WIDE.U32.X R4, P0, R6, R23, R4, P0",
    ),
    (
        0x000fe400020e04ff000000781c407225u128,
        "IMAD.WIDE.U32.X R64, R28, R120, RZ, P4",
    ),
    (
        0x000fe400020e04ff0000007a1c427225u128,
        "IMAD.WIDE.U32.X R66, R28, R122, RZ, P4",
    ),
    (
        0x000fe400020e04ff0000007b1d607225u128,
        "IMAD.WIDE.U32.X R96, R29, R123, RZ, P4",
    ),
    (
        0x080fe20001040462000003d1635a7825u128,
        "IMAD.WIDE.U32.X R90, P2, R99, 0x3d1, R98, P2",
    ),
    (
        0x080fe20001040464000003d165587825u128,
        "IMAD.WIDE.U32.X R88, P2, R101, 0x3d1, R100, P2",
    ),
    (
        0x080fe20001040466000003d167567825u128,
        "IMAD.WIDE.U32.X R86, P2, R103, 0x3d1, R102, P2",
    ),
    (
        0x080fe20007840460000003d161567825u128,
        "IMAD.WIDE.U32.X.B90 R86, P2, R97, 0x3d1, R96, PT",
    ),
    (
        0x080fe2000786043c000003d15c3c7825u128,
        "IMAD.WIDE.U32.X.B90 R60, P3, R92, 0x3d1, R60, PT",
    ),
    (
        0x080fe40007860400000003d15c007825u128,
        "IMAD.WIDE.U32.X.B90 R0, P3, R92, 0x3d1, R0, PT",
    ),
    (
    ...
    (
        ...
        "@P1 STG.E.NA.EFL2.256.STRONG.GPU [R28.U32+UR38], R44, R48",
    ), // healed 447
    (
        0x000be4000f50e026f80000341d38197fu128,
        "@P1 STG.E.NA.EFL2.256.STRONG.GPU [R29.U32+UR38], R52, R56",
    ), // healed 447
    (
        0x001ea2000812190cfe0000040208797eu128,
        "LDG.E.ENL2.256 R12, R8, desc[UR4][R2.64]",
    ),
    (
        0x001ea2000812990cfe0000040208797eu128,
        "LDG.E.ENL2.256.CONSTANT R12, R8, desc[UR4][R2.64]",
    ),
    (
        0x001eaa000812f90cfe0000040208797eu128,
        "LDG.E.ENL2.256.STRONG.GPU R12, R8, desc[UR4][R2.64]",
    ),
    (
        0x001ea2000852f90cfe0000040208797eu128,
        "LDG.E.NA.ENL2.256.STRONG.GPU R12, R8, desc[UR4][R2.64]",
    ),
    (
        0x001ea2000822f90cfe0000040208797eu128,
        "LDG.E.EL.ENL2.256.STRONG.GPU R12, R8, desc[UR4][R2.64]",
    ),
];
...
fn b4fill_decode_render_reencode_exact() {
    ...
    for &(word, golden) in GOLD {
        let d = match idx.decode(word, 0, &t) {
            Ok(d) => d,
            Err(e) => {
                fails.push(format!("word {word:032x}: decode fail: {e}"));
                continue;
            }
        };
        ...
        if text != golden {
            fails.push(format!(
                "word {word:032x}: render {text:?} != golden {golden:?}"
            ));
            continue;
        }
