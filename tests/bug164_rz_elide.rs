...
const LAWB: &[(&str, u64, u64, &str)] = &[
    ...
    ("sm103a", 0x0007fff0ff007fae, 0x0001e000081a06ff, "-0x10"), // LDGSTS_ARI_ARI_P 64,E,LTC128B tok2 neg (2026-08-26: BUG-180 s12@[32:44) vendor window law supersedes the era 19-bit pins)
    ("sm103a", 0x00040000ff007fae, 0x0001e000081a06ff, "RZ.64"), // LDGSTS_ARI_ARI_P 64,E,LTC128B tok2 min
    ("sm103a", 0x00000010ff807fae, 0x0001e00008180aff, "0x10"), // LDGSTS_ARI_ARI_P 128,BYPASS,E,LTC128B tok2 pos
    ("sm103a", 0x0007fff0ff807fae, 0x0001e00008180aff, "-0x10"), // LDGSTS_ARI_ARI_P 128,BYPASS,E,LTC128B tok2 neg 
    ("sm103a", 0x00040000ff807fae, 0x0001e00008180aff, "RZ.64"), // LDGSTS_ARI_ARI_P 128,BYPASS,E,LTC128B tok2 min
    ...
    ("sm103a", 0x0003fff0ffbc7dae, 0x0001e000081a0218, "-0x10"), // LDGSTS_ARURI_ARI_P E,LTC128B tok2 neg
    ("sm103a", 0x00020000ffbc7dae, 0x0001e000081a0218, "RZ.64"), // LDGSTS_ARURI_ARI_P E,LTC128B tok2 min
    ("sm103a", 0x00000010ff007dae, 0x0001e000081a0600, "0x10"), // LDGSTS_ARURI_ARI_P 64,E,LTC128B tok2 pos
    ("sm103a", 0x00000ff0ff007dae, 0x0001e000081a0600, "-0x10"), // LDGSTS_ARURI_ARI_P 64,E,LTC128B tok2 neg
    ...
    ("sm103a", 0x0007fff0ff807dae, 0x0001e00008180a08, "-0x10"), // LDGSTS_ARURI_ARI_P 128,BYPASS,E,LTC128B tok2 neg 
    ("sm103a", 0x00040000ff807dae, 0x0001e00008180a08, "RZ.64"), // LDGSTS_ARURI_ARI_P 128,BYPASS,E,LTC128B tok2 min
    ("sm103a", 0x00000010ff800dae, 0x0001c0000b980a00, "0x10"), // LDGSTS_ARURI_ARI 128,BYPASS,E,LTC128B tok2 pos
    ("sm103a", 0x0007fff0ff800dae, 0x0001c0000b980a00, "-0x10"), // LDGSTS_ARURI_ARI 128,BYPASS,E,LTC128B tok2 neg 
    ("sm103a", 0x00040000ff800dae, 0x0001c0000b980a00, "RZ.64"), // LDGSTS_ARURI_ARI 128,BYPASS,E,LTC128B tok2 min
    ...
    ("sm120", 0x0007fff0ff007fae, 0x0001e000081a06ff, "-0x10"), // LDGSTS_ARI_ARI_P 64,E,LTC128B tok2 neg (2026-08-26: BUG-180 s12@[32:44) vendor window law supersedes the era 19-bit pins)
    ("sm120", 0x00040000ff007fae, 0x0001e000081a06ff, "RZ.64"), // LDGSTS_ARI_ARI_P 64,E,LTC128B tok2 min
    ("sm120", 0x00000010ff807fae, 0x0001e00008180aff, "0x10"), // LDGSTS_ARI_ARI_P 128,BYPASS,E,LTC128B tok2 pos
    ("sm120", 0x0007fff0ff807fae, 0x0001e00008180aff, "-0x10"), // LDGSTS_ARI_ARI_P 128,BYPASS,E,LTC128B tok2 neg 
    ("sm120", 0x00040000ff807fae, 0x0001e00008180aff, "RZ.64"), // LDGSTS_ARI_ARI_P 128,BYPASS,E,LTC128B tok2 min
    ...
    ("sm120", 0x0007fff0ff800dae, 0x0001c0000b980a00, "-0x10"), // LDGSTS_ARURI_ARI 128,BYPASS,E,LTC128B tok2 neg 
    ("sm120", 0x00040000ff800dae, 0x0001c0000b980a00, "RZ.64"), // LDGSTS_ARURI_ARI 128,BYPASS,E,LTC128B tok2 min
    ("sm120", 0x00000010ffbc7dae, 0x0001e000081a0218, "0x10"), // LDGSTS_ARURI_ARI_P E,LTC128B tok2 pos
    ("sm120", 0x0003fff0ffbc7dae, 0x0001e000081a0218, "-0x10"), // LDGSTS_ARURI_ARI_P E,LTC128B tok2 neg
    ("sm120", 0x00020000ffbc7dae, 0x0001e000081a0218, "RZ.64"), // LDGSTS_ARURI_ARI_P E,LTC128B tok2 min
    ("sm120", 0x00000010ff007dae, 0x0001e000081a0600, "0x10"), // LDGSTS_ARURI_ARI_P 64,E,LTC128B tok2 pos
    ("sm120", 0x00000ff0ff007dae, 0x0001e000081a0600, "-0x10"), // LDGSTS_ARURI_ARI_P 64,E,LTC128B tok2 neg
    ...
    ("sm120", 0x0007fff0ff807dae, 0x0001e00008180a08, "-0x10"), // LDGSTS_ARURI_ARI_P 128,BYPASS,E,LTC128B tok2 neg 
    ("sm120", 0x00040000ff807dae, 0x0001e00008180a08, "RZ.64"), // LDGSTS_ARURI_ARI_P 128,BYPASS,E,LTC128B tok2 min
