...
static EXPECTED_DIFF: &[(&str, &str)] = &[
    ...
    ("d_ifelse_ld",   "mk10b: pozycja rekordow w kolejnosci kodu (BAR miedzy STG; desc payload[4]=00 w regionach ifwojmowych)"),
    ...
    ("r2_wr",         "desc roles/tails granice reguly first-use"),
